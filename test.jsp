...
<head>
	...
	<style type="text/css" id="Archive">
	.javascript { border: 0px solid white; }
	.Button {BACKGROUND-COLOR:#DEEB00; BORDER-BOTTOM:#000000 2px solid; BORDER-LEFT:#000000 1px solid; BORDER-RIGHT: #000000 2px solid; BORDER-TOP:#000000 1px solid; COLOR:red; FONT-FAMILY:Verdana; FONT-SIZE:12px; CURSOR:Hand;}
	.input {BACKGROUND-COLOR: #ffffff; padding: 2px; COLOR: #0000FF; FONT-FAMILY: Verdana; FONT-SIZE: 12px; font-weight:bold;}
	.DropDown {BACKGROUND-COLOR: #ffffff; COLOR: #0000FF; FONT-FAMILY: Courier; FONT-SIZE: 14px; font-weight:bold;}
	.vHide {}
	.vHide2 {}
	.inputFocus {BACKGROUND-COLOR: navy; border: solid 1px navy; padding: 2px; COLOR: #ffffff; FONT-FAMILY: Verdana; FONT-SIZE: 12px;}
	.DropDownFocus {BACKGROUND-COLOR: navy; COLOR: #ffffff; FONT-FAMILY: Verdana; FONT-SIZE: 12px; font-weight:normal; Height:12px; Line-Height:12px;}
</style>
	<!--loader-->
...
<form action="" method="post" name="country_form">
	<table align="center" width="100%" border="0" cellspacing="0" cellpadding="2" bordercolorlight="#FF99CC" 
		...
		<tr>
			...
			<select name="source_country_Input" class="DropDown" size="1" style="width:100px;font-family: courier;font-size: 14px;color: blue; font-weight:bold;" onKeyDown="if(event.keyCode==13) event.keyCode=9;" >	
	...
	<tr>
		...
		<td colspan="2" align="center">
			Filter by Country
   			...
   			<select name="source_country_Input" style="font-size: 14px; font-weight: bold; width:600px" onKeyDown="if(event.keyCode==13) event.keyCode=9;" class="DropDown" size="1">
